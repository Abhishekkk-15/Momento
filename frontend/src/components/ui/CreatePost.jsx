...
//           <Avatar>
//             <AvatarImage className="h-8 w-8 rounded-full" src={user?.profilePicture} alt="Profile" />
//             <AvatarFallback className="bg-black text-white rounded-full h-10 w-10 flex items-center p-2">CN</AvatarFallback>
//           </Avatar>
//           <div>
...
//         {imagePreview && (
//           <div className="w-full h-64 md:h-64 overflow-hidden rounded-md mb-4 flex justify-center items-center bg-gray-100">
//             <img
//               src={imagePreview}
//               alt="Preview"
...
//         {imagePreview &&
//           (loading ? (
//             <Button className="mx-auto w-full my-3 bg-[#0095F6] hover:bg-[#258bcf] active:bg-[#258bcf] focus:bg-[#0095F6] focus:outline-none">
...
//               type="submit"
//               className="mx-auto w-full my-3 bg-[#0095F6] hover:bg-[#258bcf] active:bg-[#258bcf] focus:bg-[#0095F6] focus:outline-none"
//             >
//               Post
//             </Button>
//           ))}
