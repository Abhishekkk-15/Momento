...
// const StoryViewer = ({ stories, currentIndex, onClose, onNext, onPrev }) => {
...
//       <motion.div
//         key={current._id}
//         className="relative w-80 h-96 sm:w-96 sm:h-[500px] bg-white rounded-lg shadow-lg overflow-hidden"
